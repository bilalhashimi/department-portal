    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('department_head', 'Department Head'), ('manager', 'Manager'), ('employee', 'Employee'), ('intern', 'Intern')], default='employee', max_length=20)),
